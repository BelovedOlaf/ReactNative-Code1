...
CREATE SEQUENCE trade_tradeid_seq AS integer;

CREATE TABLE IF NOT EXISTS public.trade
(
    tradeid integer NOT NULL DEFAULT nextval('trade_tradeid_seq'),
    fundname character varying(32) COLLATE pg_catalog."default" NOT NULL,
    username character varying(32) COLLATE pg_catalog."default" NOT NULL,
    stockname character varying(32) COLLATE pg_catalog."default" NOT NULL,
...
CREATE SEQUENCE message_messageid_seq AS integer;

CREATE TABLE IF NOT EXISTS public.message
(
    messageid bigint NOT NULL DEFAULT nextval('message_messageid_seq'),
    fundname character varying(32) COLLATE pg_catalog."default" NOT NULL,
    username character varying(32) COLLATE pg_catalog."default" NOT NULL,
    "time" timestamp without time zone NOT NULL,
...
CREATE SEQUENCE comment_commentid_seq AS integer;

CREATE TABLE IF NOT EXISTS public.comment
(
    commentid bigint NOT NULL DEFAULT nextval('comment_commentid_seq'),
